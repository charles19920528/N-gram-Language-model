...
def tri_prob(freq_dict_bi, freq_dict_tri, vocab_size, perturb_mass):
    prob_dict = {}
    total_perturb_mass = perturb_mass * vocab_size
...
def language_model(string, string_char_list, beg_char, vocab_size, perturb_mass):
    ...
    bigram_probability_dict = bi_prob(char_freq_dict, bi_pair_freq, vocab_size, perturb_mass_bi)
    trigram_probability_dict = tri_prob(bi_pair_freq, tri_pair_freq, vocab_size, perturb_mass_tri)
